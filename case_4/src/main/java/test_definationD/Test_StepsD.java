...
public class Test_StepsD {
	public static WebDriver driver;
	@Given("^Raj has registered in to TestMeApp$")
	public void raj_has_registered_in_to_TestMeApp() throws Throwable {
	...
	@When("^Raj enter Username as \"([^\"]*)\" and Password as \"([^\"]*)\"$")
	public void raj_enter_Username_as_and_Password_as(String username, String password) throws Throwable {
